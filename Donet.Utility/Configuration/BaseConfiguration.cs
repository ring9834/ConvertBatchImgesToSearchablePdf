...
namespace DotNet.Utilities
{
    ...
    public class BaseConfiguration
    {
        ...
        public const string COMPANY_NAME        = "HQSoft";
        ...
        //数据库表
        public const string QZCATALOGUETABLE_FORPACKAGE = "QZCatalogueTableForPackage";//案卷级卷内目录对应数据表名
        public const string QZCATALOGUETABLE_FORBOX = "QZCatalogueTableForBox";//件盒级目录对应数据表名
        public const string QZHFILEDNAME = "QZHFiledName";//在以上两个数据表中表示全宗号的字段名
        public const string ARCHIVENOFIELDNAME = "ArchiveNoFieldName";//在以上两个数据表中表示档号的字段名
        public const string FILENOFIELDNAME = "FileNoFieldName"; //案卷级卷内目录表的案卷号字段名
        public const string CATALOGUENOFIELDNAME = "CatalogueNoFieldName";//案卷级卷内目录表的目录号字段名
        public const string SECRETCLASSFIELDNAME = "SecretClassFieldName"; //案卷级或件盒级目录表的密级字段名
        public const string THEYEARFIELDNAME = "TheYearFieldName"; //件盒级目录表 年度 字段名
        public const string KEEPYEARSFIELDNAME = "KeepYearsFieldName"; //件盒级目录表 保管期限 字段名
        public const string ORGANIZATIONFIELDNAME = "OrganizationFieldName"; //件盒级目录表 机构问题 字段名
        public const string ORDIALNOFIELDNAME = "OrdialNoFieldName";//件盒级目录表 件号 字段名
