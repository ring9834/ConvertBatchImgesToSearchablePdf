...
namespace DotNet.Utilities
{
    ...
    public class BaseSystemInfo
    {
        ...
        //档案案卷级和件盒级目录对应数据表名
        public static string QZCatalogueTableForPackage = string.Empty;
        public static string QZCatalogueTableForBox = string.Empty;
        
        public static string QZHFiledName = string.Empty;
        public static string ArchiveNoFieldName = string.Empty;
        public static string FileNoFieldName = string.Empty;
        public static string CatalogueNoFieldName = string.Empty;
        public static string SecretClassFieldName = string.Empty;
        public static string TheYearFieldName = string.Empty;
        public static string KeepYearsFieldName = string.Empty;
        public static string OrganizationFieldName = string.Empty;
        public static string OrdialNoFieldName = string.Empty;
        ...
        public static string RegisterException = "请您联系： 菏泽市档案局 黄会勇 手机：15550780366 电子邮件：87967576@qq.com。";
        ...
        public static string CustomerPhone = "15550780366";			    // 当前客户公司电话
        public static string CompanyFullName     = "菏泽市档案局";	// 公司名称
        public static string CompanyPhone = "15550780366";			    // 公司电话

        public static string Copyright                  = "Copyright 2003-2010 Jirisoft Corporation";
        public static string BugFeedback = @"mailto:87967576@qq.com?subject=对费用报销管理的反馈&body=这里输入您宝贵的反馈";
        ...
        public static bool   NeedRegister               = true;				    // 是否需要注册
        ...
        // 错误报告相关
        public static string ErrorReportTo          = "87967576@qq.com";   // 发送给谁，用,;符号隔开
